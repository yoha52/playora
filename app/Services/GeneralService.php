...
{
    private static function countriesCurrencyArray(): array
    {
        return [
            'AED' => [
    ...
    {
        $arr = self::countriesCurrencyArray();
        $data = [];
        foreach ($arr as $key => $value) {
            $data[$key] = $value['title'].' ('.$key.')';
        }
    ...
    public static function getCurrencySymbol(string $id): string
    {
        $arr = self::countriesCurrencyArray();

        return $arr[$id]['symbol'];
    }
}
